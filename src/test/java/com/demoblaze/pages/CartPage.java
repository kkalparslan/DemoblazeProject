...
public class CartPage extends BasePage {
    int actualAmount;
    @FindBy(xpath = "//button[text()='Place Order']")  //@FindBy(xpath = "//button[text()='Place Order']")
    ...
    public void verifyPurchaseAmount_mtd(int expectedAmount){
        ...
        System.out.println("ProductPage.productNumber = " + ProductPage.productNumber);
    }
}
